...
export default function AdminAddProductPage() {
  ...
  const [form, setForm] = useState<FormState>({
    name: "", category: "", price: "", originalPrice: "", unit: "dịch vụ",
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-sm p-10 max-w-md w-full text-center">
          ...
          <div className="flex flex-col gap-3">
            <div className="flex gap-3">
              ...
              <button onClick={() => { setSubmitted(false); setImageFiles([]); setPreviews([]); setContactPrice(false); }}
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 p-6 space-y-4">
            ...
            <div>
              ...
              <textarea value={form.desc} onChange={(e) => setField("desc", e.target.value)}
                rows={4} placeholder="Mô tả chi tiết về sản phẩm hoặc dịch vụ..."
          ...
          {/* Images */}
          <div className="bg-white rounded-2xl border border-gray-200 p-6 space-y-4">
            <h2 className="font-bold text-gray-900 flex items-center gap-2"><span>🖼️</span> Ảnh minh họa <span className="text-gray-400 font-normal text-sm">(tối đa {MAX_IMAGES} ảnh)</span></h2>
            ...
            <p className="text-xs text-gray-400">Ảnh đầu tiên là ảnh chính hiển thị trên thẻ sản phẩm.</p>
          </div>
